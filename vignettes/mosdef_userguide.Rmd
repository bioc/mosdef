...
* `Annotated`: The number of genes in your dataset that are associated with this term (TODO Or is this the number of genes overall associated with this term.And then in the col "Significant" is the number of these term associated genes that are significantly enriched in the analyzed dataset )
